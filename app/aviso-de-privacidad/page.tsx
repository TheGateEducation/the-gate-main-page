    ...
    <main className="min-h-screen bg-gray-50 py-16 md:py-24 px-4">
      <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="mb-10 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-[#1a2b4c] mb-4">
            AVISO DE PRIVACIDAD
          </h1>
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            <h3 className="text-xl font-bold text-[#1a2b4c] mb-4">1. Finalidades del tratamiento de datos personales</h3>
            <p className="mb-4">
            ...
            <p className="mt-4">
              ...
              enviando un correo electrónico a <a href="mailto:info@thegate-education.com" className="text-[#FA5939] hover:underline">info@thegate-education.com</a>.
            </p>
          </section>

          <section>
            <h3 className="text-xl font-bold text-[#1a2b4c] mb-4">2. Datos personales que se recaban</h3>
            <p>
          ...
          <section>
            <h3 className="text-xl font-bold text-[#1a2b4c] mb-4">3. Transferencia de datos</h3>
          ...
          <section>
            <h3 className="text-xl font-bold text-[#1a2b4c] mb-4">4. Ejercicio de derechos ARCO</h3>
            <p className="mb-4">
              Usted tiene derecho a acceder, rectificar, cancelar u oponerse (ARCO) al tratamiento de sus
              datos personales. Para ejercer estos derechos, deberá enviar una solicitud al correo <a href="mailto:info@thegate-education.com" className="text-[#FA5939] hover:underline">info@thegate-education.com</a>, indicando:
            </p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h3 className="text-xl font-bold text-[#1a2b4c] mb-4">5. Uso de tecnologías de rastreo</h3>
            <p>
          ...
          <section>
            <h3 className="text-xl font-bold text-[#1a2b4c] mb-4">6. Cambios al aviso de privacidad</h3>
            <p>
              TGE podrá modificar este aviso en cualquier momento. Cualquier cambio será publicado en
              el sitio web <Link href="/" className="text-[#FA5939] hover:underline">www.thegate-education.com</Link>, en la sección "Aviso de privacidad".
            </p>
          </section>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 text-center">
          <Link 
            href="/" 
            className="inline-block bg-[#1a2b4c] text-white py-3 px-8 rounded-xl font-bold hover:bg-[#FA5939] transition-colors duration-300"
          >
            Volver al inicio
          </Link>
        </div>
