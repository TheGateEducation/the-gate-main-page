...
import { GraduationCap, Globe2, Briefcase, Award } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 text-white">
              ...
              <p className="text-xl md:text-2xl text-white/90 font-medium mb-10 leading-relaxed max-w-2xl">
                Especialízate en las mejores universidades del mundo. Conecta con empleadores internacionales y transforma tu futuro profesional.
              </p>
            ...
            <div className="lg:col-span-5 bg-white/10 backdrop-blur-xl p-8 md:p-12 rounded-[2.5rem] border border-white/20 shadow-2xl relative overflow-hidden">
              ...
              <div className="space-y-6 relative z-10">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-base font-medium">
                      EE.UU., Reino Unido, Canadá, Alemania, Australia.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-white/10 p-3 rounded-xl">
                    <Briefcase className="w-6 h-6 text-[#EDA74C]" />
                  </div>
                  <div>
                    <strong className="text-white block text-lg mb-1">Áreas populares</strong>
                    <p className="text-white/80 text-base font-medium">
                      MBA, Data Science, Ingeniería, Salud, Negocios Internacionales.
                    </p>
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-white/10 grid grid-cols-2 gap-4">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <Award className="w-5 h-5 text-[#EDA74C]" />
                      <strong className="text-white">Duración</strong>
                    </div>
                    <p className="text-white/80 text-sm font-medium">1 a 2 años</p>
                  </div>
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <GraduationCap className="w-5 h-5 text-[#EDA74C]" />
                      <strong className="text-white">Nivel</strong>
                    </div>
                    <p className="text-white/80 text-sm font-medium">Posgrado</p>
                  </div>
                </div>
              </div>
            </div>
