...
import { GraduationCap, Sparkles, Users, MapPin, Rocket } from "lucide-react";

export const metadata = {
  title: "Programas - The Gate Education",
  description:
    "Conoce la oferta que tenemos para ti en educación internacional.",
  keywords:
    "campamentos, certificados y diplomas, cursos de idiomas, intercambios, maestrias, tours de estudio, secundaria, educación y formación profesional",
};
...
const beneficios = [
  {
    ...
    description: "Desde campamentos para jóvenes hasta maestrías y doctorados.",
  },
  {
    icon: MapPin,
    title: "15+ países",
    description: "Programas en los destinos educativos más reconocidos del mundo.",
  },
  {
    icon: Users,
    title: "Asesoría personalizada",
    description: "Te ayudamos a encontrar el programa perfecto para tu perfil.",
  },
];
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative pt-24 pb-32 md:pt-32 md:pb-48 flex items-center overflow-hidden min-h-[60vh]">
        <div className="absolute inset-0 z-0">
          <img
            src="https://images.unsplash.com/photo-1498243691581-b145c3f54a5a?auto=format&fit=crop&w=2070&q=80"
            alt="Estudiantes internacionales explorando sus opciones académicas"
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            <div className="lg:col-span-7 text-white">
              ...
              <p className="text-xl md:text-2xl text-white/90 font-medium mb-10 leading-relaxed max-w-2xl">
                Desde campamentos hasta doctorados — descubre el programa ideal para tu siguiente aventura internacional.
              </p>
      ...
      {/* ── Section header + Program listing ────────────────────────────────── */}
      <div id="categorias" className="relative z-10 -mt-20 md:-mt-32 scroll-mt-24">
        <section className="px-4 max-w-[1200px] mx-auto pt-32 md:pt-48 pb-4 text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-extrabold text-gray-900 mb-6 tracking-tight leading-tight">
            Elige tu <span className="text-gradient">camino ideal</span>
          </h2>
