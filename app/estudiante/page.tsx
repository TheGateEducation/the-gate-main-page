...
const allServices: Service[] = [
  ...
  },
  {
    id: 2,
    category: "Gratuitos",
    title: "Envío de primeras opciones",
    description:
      "Recibe un primer listado con máximo tres universidades en hasta tres países distintos, seleccionadas según tu perfil e intereses.",
    price: 0,
    borderColor: "#5F338B",
  },
  // Servicios Completos
  {
    id: 3,
    category: "Servicios Completos",
    title: "Servicio de Orientación",
    description:
      "Incluye revisión de beneficios por país (estudio, trabajo, posgrados), envío de opciones académicas, recepción y certificación de documentos, información sobre becas y apoyos, métodos de pago, hospedaje y viaje.",
    price: 500,
    borderColor: "#EDA74C",
  },
  {
    ...
    description:
      "Incluye revisión de CV, carta de motivación, ensayo para beca y preparación para entrevistas. También orientación para visa, hospedaje y plan de viaje.",
    price: 89,
    borderColor: "#EDA74C",
  },
...
export default function Estudiante() {
  ...
  const servicesGratuitos = allServices.filter(
    (s) => s.category === "Gratuitos",
  );
  const servicesCompletos = allServices.filter(
    (s) => s.category === "Servicios Completos",
  );
  const servicesSeparado = allServices.filter(
    (s) => s.category === "Servicios por Separado",
  );
    ...
    <main>
      ...
      <div className="mx-auto max-w-5xl space-y-8 px-4 py-12 sm:px-6 lg:px-8">
        <div className="flex w-full flex-col items-center space-y-8">
          <h1 className="font-inter text-center font-bold text-[#5F338B] text-3xl leading-tight sm:text-4xl lg:text-5xl">
            Gratuitos
          </h1>
          ...
          <h1 className="pt-20 font-inter text-center font-bold text-[#EDA74C] text-3xl leading-tight sm:text-4xl lg:text-5xl">
            Servicios Completos
          </h1>
          ...
          <h1 className="pt-20 font-inter text-center font-bold text-[#5F338B] text-3xl leading-tight sm:text-4xl lg:text-5xl">
            Servicios por Separado
          </h1>
