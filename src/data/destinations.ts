...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    placeImage: "/images/places/nueva-zelanda.jpg",
    programs: "10+",
    ...
    href: "/destinos#nueva-zelanda",
    details: {
      paragraphs: [
        "Nueva Zelanda cuenta con 8 universidades, todas bien posicionadas a nivel internacional, y recibe más de 100,000 estudiantes internacionales.",
        "Ubicada en Oceanía, tiene una superficie de 268,000 km². Es conocida por su naturaleza, seguridad y calidad de vida. Su clima es templado, con variaciones regionales.",
        "Su economía es estable, con un PIB de aproximadamente $250 mil millones de USD, basada en agricultura, turismo y servicios.",
        "Es uno de los países más seguros del mundo. El costo de vida ronda entre NZD $1,200–$2,000 mensuales.",
        "Ideal para estudiantes que buscan tranquilidad, seguridad y calidad educativa.",
      ],
